...
do
	...
	sphinx-apidoc -o docs/developer fhi_aims_step
...
<html>
   <head>
      <title>Documentation for the FHI-aims plug-in for SEAMM</title>
   </head>
   <body>
      <h1>Documentation for the FHI-aims plug-in for SEAMM</h1>
      <h2>Branches</h2>
      <ul>
EOF
